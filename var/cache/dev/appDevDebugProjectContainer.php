...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ma_platform.antispam' => 'getMaPlatform_AntispamService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\MA\\PlatformBundle\\Entity'))), 'MA\\PlatformBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MAPlatformBundle' => 'MA\\PlatformBundle\\Entity'));
    ...
    /**
     * Gets the public 'ma_platform.antispam' shared service.
     *
     * @return \MA\PlatformBundle\Antispam\MAAntispam
     */
    protected function getMaPlatform_AntispamService()
    {
        return $this->services['ma_platform.antispam'] = new \MA\PlatformBundle\Antispam\MAAntispam(${($_ = isset($this->services['swiftmailer.mailer.default']) ? $this->services['swiftmailer.mailer.default'] : $this->get('swiftmailer.mailer.default')) && false ?: '_'}, 'en', 30);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MA\\PlatformBundle/Resources/views'), 'MAPlatform');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f9924bf560830d48d81af2eaf75f5f45f102145b');
    }
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mXU5cJIssk', 0, 'rQZahpTlOhlCqBzYnY0xhD', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aemO31ygXM', 0, 'rQZahpTlOhlCqBzYnY0xhD', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BVOi0XIECG', 0, 'rQZahpTlOhlCqBzYnY0xhD', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5c6d6642597eb0.68508577');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'MAPlatformBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MA\\PlatformBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MAPlatformBundle' => 'MA\\PlatformBundle\\MAPlatformBundle',
            ...
            'secret' => 'f9924bf560830d48d81af2eaf75f5f45f102145b',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'f9924bf560830d48d81af2eaf75f5f45f102145b',
