...
class B extends A 
{
    ...
    {
        $nb = parent::calcul(); // il est possible d'atteindre une méthode de mon parent, mêm s'il n'y a pas de redéfinition 
        return $nb;
    }
}
//---------------------------------------------------------
...
// contexte => pour la surcharge, si on faisait pas ça dans wordpress, on ne pourrais pas mettre à jour le CMS, on modifierais directement les fonctions du coeur !
$b = new B;
echo $b->calcul() . '<hr>';
